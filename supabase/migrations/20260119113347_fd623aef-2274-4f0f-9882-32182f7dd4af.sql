-- Fix: Change p.branch_id to p.assigned_branch_id in auto_route_observation_on_submit trigger
-- The profiles table uses assigned_branch_id, not branch_id
...
BEGIN
  ...
  -- Check for 'submitted' (valid enum value) instead of 'reported'
