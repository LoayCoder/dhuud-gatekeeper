-- Migration: Update Incident Routing (All incidents go to Expert Screening)
-- Date: 2026-02-20
...
BEGIN
  ...
  -- Get severity and tenant_id (kept for audit log, but removed from routing logic)
  ...
  -- UPDATED ROUTING: All approved incidents go to Expert Screening
  ...
  VALUES (
    ...
    jsonb_build_object(
      ...
      'routing_note', 'All severities routed to Expert Screening'
    ),
    _tenant_id
  );
