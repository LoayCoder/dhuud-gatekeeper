...
DROP FUNCTION IF EXISTS public.get_hsse_contact_for_location(uuid);
DROP FUNCTION IF EXISTS public.get_hsse_contact_for_location(uuid, uuid);

-- Create the new function with both parameters and smart fallback
...
GRANT EXECUTE ON FUNCTION public.get_hsse_contact_for_location(uuid, uuid) TO authenticated;
