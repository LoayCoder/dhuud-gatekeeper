...
-- Drop both duplicate function signatures
...
DROP FUNCTION IF EXISTS public.submit_public_gate_pass(text, uuid, text, text, text, text, text, text, text, text, date, text, text, text, text, boolean, boolean, boolean, text, jsonb, date, date);

-- Recreate single clean function (matches frontend parameter order)
...
BEGIN
  ...
  -- FIX: tenants table has no deleted_at column
