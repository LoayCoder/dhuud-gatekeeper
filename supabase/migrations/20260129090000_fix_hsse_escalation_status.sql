...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    -- Included hsse_manager_escalation
    'open_investigations', COUNT(*) FILTER (WHERE status IN ('investigation_in_progress', 'expert_screening', 'pending_manager_approval', 'hsse_manager_escalation')),
  ...
  SELECT jsonb_build_object(
    ...
    'hsse_manager_escalation', COUNT(*) FILTER (WHERE status = 'hsse_manager_escalation'), -- Added
