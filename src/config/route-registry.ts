...
export const routeRegistry: RouteDefinition[] = [
  ...
  },
  {
    ...
    title: { en: "Site Clearance", ar: "تصريح الموقع" },
    icon: HardHat,
    component: lazyWithRetry(() => import("@/pages/mobilization/SiteClearanceDashboard")),
    protection: "hsse",
    parentCode: "ptw_module",
    sortOrder: 2,
  },
  {
    path: "/site-clearance/:projectId",
    menuCode: "ptw_project_clearance",
    title: { en: "Site Clearance Detail", ar: "تفاصيل تصريح الموقع" },
    icon: CheckCircle2,
    component: lazyWithRetry(() => import("@/pages/mobilization/SiteClearanceDetail")),
    protection: "hsse",
    hidden: true,
    hiddenReason: "Dynamic route - accessed via site clearance list",
  },
  {
    path: "/ptw/console",
