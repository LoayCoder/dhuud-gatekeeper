...
export const routeRegistry: RouteDefinition[] = [
  ...
  },
  {
    ...
    title: { en: "Site Mobilization", ar: "تعبئة الموقع" },
    icon: HardHat,
    component: lazyWithRetry(() => import("@/pages/mobilization/MobilizationDashboard")),
    protection: "hsse",
    parentCode: "ptw_module",
    sortOrder: 2,
  },
  {
    path: "/mobilization/:projectId",
    menuCode: "ptw_project_clearance",
    title: { en: "Mobilization Detail", ar: "تفاصيل التعبئة" },
    icon: CheckCircle2,
    component: lazyWithRetry(() => import("@/pages/mobilization/MobilizationDetail")),
    protection: "hsse",
    hidden: true,
    hiddenReason: "Dynamic route - accessed via mobilization list",
  },
  {
    path: "/ptw/console",
