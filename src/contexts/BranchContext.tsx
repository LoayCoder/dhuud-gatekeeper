...
export function BranchProvider({ children }: { children: React.ReactNode }) {
  ...
  const hasFullBranchAccess = (profile as unknown)?.is_super_admin === true || (profile as unknown)?.has_full_branch_access === true;
    ...
    try {
      ...
      if (hasFullBranchAccess) {
        ...
        if (assignments && assignments.length > 0) {
          ...
          const assignedBranchId = (profile as unknown)?.assigned_branch_id;
          if (assignedBranchId) {
