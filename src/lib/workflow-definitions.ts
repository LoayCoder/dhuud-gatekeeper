...
export const observationWorkflow: WorkflowDefinition = {
  ...
  description: 'End-to-end workflow for safety observations from submission to closure',
  descriptionAr: 'سير العمل الكامل لملاحظات السلامة من التقديم إلى الإغلاق',
  ...
  steps: [
    ...
    { id: 'decision_screening', type: 'decision', label: 'Screening Decision', labelAr: 'قرار الفحص' },
    { id: 'return_reporter', type: 'action', label: 'Return to Reporter', labelAr: 'إعادة للمُبلِّغ', actor: 'HSSE Expert', actorAr: 'خبير السلامة' },
    { id: 'dept_rep_approval', type: 'approval', label: 'Dept Rep Approval', labelAr: 'موافقة ممثل القسم', actor: 'Dept Rep', actorAr: 'ممثل القسم' },
    ...
    { id: 'no_investigation', type: 'action', label: 'Close - No Investigation', labelAr: 'إغلاق - بدون تحقيق', actor: 'HSSE Expert', actorAr: 'خبير السلامة' },
    { id: 'end', type: 'end', label: 'Observation Closed', labelAr: 'إغلاق الملاحظة' },
  ],
  connections: [
    { from: 'start', to: 'expert_screening' },
    { from: 'expert_screening', to: 'decision_screening' },
    { from: 'decision_screening', to: 'return_reporter', condition: 'reject', label: 'Return', labelAr: 'إعادة' },
    { from: 'decision_screening', to: 'dept_rep_approval', condition: 'approve', label: 'Send for Action', labelAr: 'إرسال للإجراء' },
    { from: 'decision_screening', to: 'upgrade_incident', condition: 'escalate', label: 'Upgrade', labelAr: 'ترقية' },
    { from: 'decision_screening', to: 'no_investigation', condition: 'no', label: 'No Investigation', labelAr: 'بدون تحقيق' },
    { from: 'return_reporter', to: 'start' },
    { from: 'dept_rep_approval', to: 'assign_actions' },
    { from: 'assign_actions', to: 'end' },
    { from: 'upgrade_incident', to: 'end' },
    { from: 'no_investigation', to: 'end' },
  ],
};
