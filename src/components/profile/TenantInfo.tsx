...
export function TenantInfoContent({ memberSince }: TenantInfoProps) {
...
// Legacy wrapper with Card for backward compatibility
export function TenantInfo({ memberSince }: TenantInfoProps) {
  ...
  return (
    <div dir={direction}>
      <TenantInfoContent memberSince={memberSince} />
    </div>
  );
}
