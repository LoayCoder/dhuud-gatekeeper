                                ...
                                <div className="flex flex-col md:flex-row">
                                    ...
                                    <div className="p-5 md:w-1/3 border-b md:border-b-0 md:border-r bg-muted/10">
                                        ...
                                        <div className="mt-auto space-y-3">
                                            ...
                                            <ResponsibleUserBadge incident={incident as any} className="scale-[0.85] origin-left" />
                                        </div>
                                    </div>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            {!isComplete && (
                                                <div className={cn(
                                                    ...
                                                    {sla.isOverdue
                                                        ? t('investigation.sla.overdueBy', { count: Math.abs(sla.daysRemaining), defaultValue: `Overdue by ${Math.abs(sla.daysRemaining)} days ⚠️` })
