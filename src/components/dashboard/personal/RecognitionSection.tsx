...
export function RecognitionSection() {
    ...
    return (
        <div className="space-y-4">
            <h2 className="text-xl font-semibold tracking-tight">Recognition & Achievements</h2>
            ...
            <div className="grid gap-4 md:grid-cols-2">
                ...
                <Card className="p-6 space-y-6 cursor-pointer hover:shadow-md transition-all" onClick={() => navigate('/achievements')}>
                    <div className="flex items-center space-x-2">
                        ...
                        <h3 className="font-medium text-lg">Your HSSE Ranking</h3>
                    </div>
                    ...
                    <div className="text-center pt-2">
                        ...
                        <p className="text-sm text-muted-foreground italic mt-2">"Keep reporting to climb higher!"</p>
                    </div>
                </Card>
                ...
                <Card className="p-6 space-y-6 cursor-pointer hover:shadow-md transition-all" onClick={() => navigate('/achievements')}>
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                            ...
                            <h3 className="font-medium text-lg">My Achievements</h3>
                        </div>
                    ...
                    <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                        ...
                        <span>{earnedBadgesCount} badges earned</span>
                    </div>

                    {/* Collected Badges */}
                    {earnedBadgesCount > 0 && (
                        <div className="space-y-3">
                            <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Collected Badges</span>
                    ...
                    {nextBadge ? (
                        <div className="pt-2 border-t">
                            ...
                            <div className="bg-muted/30 p-3 rounded-xl flex items-center space-x-3">
