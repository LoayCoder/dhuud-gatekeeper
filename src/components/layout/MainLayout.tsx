  ...
  return <SidebarProvider>
      <div className="flex min-h-screen w-full overflow-x-hidden">
        ...
        <SidebarInset className="min-w-0 flex flex-col w-full">
          ...
          <header 
            className="fixed top-0 start-0 end-0 z-50 bg-background/95 backdrop-blur-md supports-[backdrop-filter]:bg-background/80 min-h-12 sm:min-h-14 md:min-h-16 h-auto shrink-0 items-center justify-between gap-1.5 sm:gap-2 border-b px-2 sm:px-3 md:px-4 transition-all ease-linear flex flex-row flex-wrap md:start-[var(--sidebar-width,0px)] group-has-[[data-collapsible=icon]]/sidebar-wrapper:md:start-[var(--sidebar-width-icon,3rem)]"
            style={{ 
