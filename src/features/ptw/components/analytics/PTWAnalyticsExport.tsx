...
import { PTWAnalyticsData } from "@/features/ptw/hooks/use-ptw-analytics";
...
export function PTWAnalyticsExport({
  ...
  const handleExportExcel = async () => {
    ...
    // Log export action
    await logExport(entityType, 'excel', permits.length, { dateRange });
  ...
  const handleExportPDF = async () => {
    ...
    try {
      // Log export action
      await logExport(entityType, 'pdf', permits.length, { dateRange });
