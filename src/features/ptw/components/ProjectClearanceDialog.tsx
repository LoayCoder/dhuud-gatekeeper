...
import { useProjectClearances as usePTWProjectClearances, useApproveClearanceCheck, useRejectClearanceCheck } from "@/hooks/ptw";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[85vh]">
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between gap-2">
                              ...
                              >
                                {String(t(`ptw.clearance.status.${check.status}`, check.status))}
                              </Badge>
                            </div>
        ...
        <DialogFooter className="sm:justify-between">
          <Link to={`/site-clearance/${projectId}`}>
