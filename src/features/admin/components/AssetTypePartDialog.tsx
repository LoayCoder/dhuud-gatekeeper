...
import type { AssetTypePart, CreateAssetTypePartInput, UpdateAssetTypePartInput } from '@/features/assets';
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} placeholder="e.g., Ø®Ø±Ø·ÙˆÙ…" dir="rtl" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea {...field} rows={2} placeholder="ÙˆØµÙ Ø§Ø®ØªÙŠØ§Ø±ÙŠ..." dir="rtl" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
