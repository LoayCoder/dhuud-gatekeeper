...
import { useFleetHealthStats, useAtRiskAssets } from '@/features/assets';
import { useHealthTrendData } from '@/features/assets';
import { useAssetFailurePredictions } from '@/features/assets';
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="flex flex-col items-center justify-center rounded-lg border bg-muted/30 p-4">
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              {!statsLoading && <TrendIndicator trend={overallTrend} count={0} />}
            </div>
