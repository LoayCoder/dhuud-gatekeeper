...
import { useCreateGateEntry, useRecordExit } from '@/features/security';
                    ...
                    <div className="mt-2 text-xs">
                      {verificationResult.qrValidity.isValid ? (
                        <span className="text-green-600 dark:text-green-400">
                          âœ“ {t('security.workerVerification.qrValid', 'Valid QR')}
                        ...
                        <span className="text-destructive">
                          âœ— {t('security.workerVerification.qrInvalid', 'No valid QR')}
                        </span>
                      )}
                    </div>
                  )}
