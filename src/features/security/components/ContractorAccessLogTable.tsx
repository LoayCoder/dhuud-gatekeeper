...
import { ContractorAccessLog, useRecordExit } from '@/features/contractors';
  ...
  return (
    <div className="rounded-md border">
      <Table>
        ...
        <TableBody>
          {logs.map((log) => {
            const contractor = log.contractor as import('@/features/security/types').ContractorAccessContractor | null;
            return (
              <TableRow key={log.id}>
                <TableCell>
