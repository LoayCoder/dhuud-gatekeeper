  ...
  useEffect(() => {
    if (open) {
      form.reset({
        ...
        inspection_category_id: template?.inspection_category_id || undefined,
        area_type: template?.area_type || undefined,
        standard_reference: template?.standard_reference || '',
        passing_score_percentage: template?.passing_score_percentage || 80,
