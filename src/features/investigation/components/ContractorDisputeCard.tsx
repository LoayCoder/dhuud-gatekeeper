...
const DISPUTE_TYPE_OPTIONS: Array<{ value: ContractorDisputeType; labelEn: string; labelAr: string }> = [
  { value: 'liability_denial', labelEn: 'Liability Denial', labelAr: 'Ø±ÙØ¶ Ø§Ù„Ù…Ø³Ø¤ÙˆÙ„ÙŠØ©' },
  { value: 'evidence_dispute', labelEn: 'Evidence Dispute', labelAr: 'Ø®Ù„Ø§Ù Ø¹Ù„Ù‰ Ø§Ù„Ø£Ø¯Ù„Ø©' },
  { value: 'procedural_issue', labelEn: 'Procedural Issue', labelAr: 'Ù…Ø´ÙƒÙ„Ø© Ø¥Ø¬Ø±Ø§Ø¦ÙŠØ©' },
  { value: 'other', labelEn: 'Other', labelAr: 'Ø£Ø®Ø±Ù‰' },
];

const DISPUTE_STATUS_LABELS: Record<string, { en: string; ar: string; color: string }> = {
  pending_review: { en: 'Pending Review', ar: 'Ù‚ÙŠØ¯ Ø§Ù„Ù…Ø±Ø§Ø¬Ø¹Ø©', color: 'bg-amber-100 text-amber-800' },
  upheld: { en: 'Upheld', ar: 'Ù…Ù‚Ø¨ÙˆÙ„', color: 'bg-green-100 text-green-800' },
  rejected: { en: 'Rejected', ar: 'Ù…Ø±ÙÙˆØ¶', color: 'bg-red-100 text-red-800' },
  partially_accepted: { en: 'Partially Accepted', ar: 'Ù…Ù‚Ø¨ÙˆÙ„ Ø¬Ø²Ø¦ÙŠØ§Ù‹', color: 'bg-blue-100 text-blue-800' },
};
