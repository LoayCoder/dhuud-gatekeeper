...
const DISPUTE_STATUS_OPTIONS: Array<{ 
  ...
  { 
    ...
    labelAr: 'Ù‚Ø¨ÙˆÙ„ Ø§Ù„Ù†Ø²Ø§Ø¹',
    descEn: 'Accept the contractor\'s dispute. Remove or reduce liability.',
    descAr: 'Ù‚Ø¨ÙˆÙ„ Ù†Ø²Ø§Ø¹ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„. Ø¥Ø²Ø§Ù„Ø© Ø£Ùˆ ØªÙ‚Ù„ÙŠÙ„ Ø§Ù„Ù…Ø³Ø¤ÙˆÙ„ÙŠØ©.',
    icon: CheckCircle,
  ...
  { 
    ...
    labelAr: 'Ø±ÙØ¶ Ø§Ù„Ù†Ø²Ø§Ø¹',
    descEn: 'Reject the dispute. Original finding stands.',
    descAr: 'Ø±ÙØ¶ Ø§Ù„Ù†Ø²Ø§Ø¹. Ø§Ù„Ù†ØªÙŠØ¬Ø© Ø§Ù„Ø£ØµÙ„ÙŠØ© ØªØ¸Ù„ Ù‚Ø§Ø¦Ù…Ø©.',
    icon: XCircle,
    color: 'text-red-600'
  },
  { 
    ...
    labelAr: 'Ù‚Ø¨ÙˆÙ„ Ø¬Ø²Ø¦ÙŠ',
    descEn: 'Partially accept the dispute. Modify findings or liability.',
    descAr: 'Ù‚Ø¨ÙˆÙ„ Ø¬Ø²Ø¦ÙŠ Ù„Ù„Ù†Ø²Ø§Ø¹. ØªØ¹Ø¯ÙŠÙ„ Ø§Ù„Ù†ØªØ§Ø¦Ø¬ Ø£Ùˆ Ø§Ù„Ù…Ø³Ø¤ÙˆÙ„ÙŠØ©.',
    icon: Scale,
    color: 'text-blue-600'
  },
];
