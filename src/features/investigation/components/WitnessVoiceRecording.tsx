// ARCHITECTURE NOTE:
// Only 3 form fields use react-hook-form.
// 12 recording/transcription/AI states kept
// as useState — they are UI state, not form data.
...
import { witnessVoiceRecordingSchema, type WitnessVoiceRecordingFormValues } from "./WitnessVoiceRecordingSchema";
...
export function WitnessVoiceRecording({ 
  ...
  const form = useForm<WitnessVoiceRecordingFormValues>({
    resolver: zodResolver(witnessVoiceRecordingSchema),
    defaultValues: {
      witnessName: '',
      witnessContact: '',
      relationship: '',
  ...
  // Recording UI state (kept as useState)
  ...
  const onSubmit = async (data: WitnessVoiceRecordingFormValues) => {
    ...
    try {
      ...
      console.error("[WitnessVoiceRecording] Error saving statement:", error);
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-center gap-2">
              {!audioBlob ? (
                <>
                  {!isRecording ? (
                    <Button type="button" onClick={startRecording} variant="destructive">
                ...
                <>
                  ...
                  <Button type="button" onClick={resetRecording} variant="outline" size="icon">
        ...
        {transcription && (
          <div className="space-y-2">
            ...
            <div className="flex justify-between">
              ...
              {!isApproved && (
                <Button type="button" onClick={handleApprove} variant="default">
        ...
        <div className="flex justify-end gap-2 pt-4">
          <Button 
            type="submit"
            disabled={isSubmitting || !transcription.trim() || !isApproved}
          >
