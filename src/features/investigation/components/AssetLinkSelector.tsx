...
import { useSearchAssetsForLinking, useLinkAssetToIncident, type AssetLinkType, useDebounce } from '@/features/incidents';
...
export function AssetLinkSelector({ incidentId, linkedAssetIds, onLinked }: AssetLinkSelectorProps) {
  ...
  const [selectedAsset, setSelectedAsset] = useState<{ id: string; name: string; asset_code: string } | null>(null);
