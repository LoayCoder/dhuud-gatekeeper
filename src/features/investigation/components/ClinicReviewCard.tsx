    ...
    <div className="space-y-4" dir={direction}>
      <Card className="border-rose-500/50 bg-rose-500/5">
        ...
        <CardContent className="space-y-4">
          ...
          {(incident as unknown as import('../types/investigationTypes').ViolationIncidentFields).injury_info && (
            <div className="rounded-lg border border-muted p-4 space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                {(incident as unknown as import('../types/investigationTypes').ViolationIncidentFields).injury_info || t('workflow.clinic.noInjuryInfo', 'No injury details provided by reporter')}
              </p>
            </div>
          )}
