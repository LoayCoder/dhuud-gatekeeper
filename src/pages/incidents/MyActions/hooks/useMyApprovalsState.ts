...
export function useMyApprovalsState() {
  ...
  const { data: pendingApprovals, isLoading: isApprovalsLoading } = usePendingActionApprovals();
  ...
  const approvalsLoading = isApprovalsLoading || severityLoading || potentialSeverityLoading;
