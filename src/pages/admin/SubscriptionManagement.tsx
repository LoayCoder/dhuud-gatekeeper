...
export default function SubscriptionManagement() {
  ...
  const [requestToCancel, setRequestToCancel] = useState<{ id: string; requested_plan?: { display_name?: string }; requested_user_limit?: number; calculated_total_monthly?: number; billing_period?: string } | null>(null);
  const {
    plans,
    modules,
    isLoading,
  ...
  const cancelRequest = useMutation({
    mutationFn: async (request: { id: string; requested_plan?: { display_name?: string }; requested_user_limit?: number; calculated_total_monthly?: number; billing_period?: string }) => {
      const {
        error
