...
export default function AdminBranding() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto text-start" dir={direction}>
        ...
        <Tabs defaultValue="visuals" className="w-full" dir={direction}>
          ...
          <TabsContent value="assets" className="w-full">
            <div className="flex flex-col space-y-6">
              ...
              <Card className="w-full">
                <CardHeader>
                  <CardTitle className="text-start">{t('adminBranding.assets.favicon.title')}</CardTitle>
              ...
              <CardContent className="flex flex-col space-y-6">
                ...
                {bgTheme === 'color' ? (
                  ...
                  <div className="flex flex-col space-y-4 w-full">
                    ...
                    <div
                      className="border-2 border-dashed rounded-lg p-4 min-h-[200px] bg-cover bg-center relative group w-full"
