                ...
                <div className="flex gap-2">
                  ...
                  <Select value={statusFilter} onValueChange={setStatusFilter}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="expired">{t("contractors.passStatus.expired", "Expired")}</SelectItem>
                      <SelectItem value="cancelled">{t("contractors.passStatus.cancelled", "Cancelled")}</SelectItem>
                      <SelectItem value="completed">{t("contractors.passStatus.completed", "Completed")}</SelectItem>
                      <SelectItem value="pending_resubmission">{t("contractors.passStatus.pendingResubmission", "Pending Resubmission")}</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
