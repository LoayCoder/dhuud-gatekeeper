...
const userTypeCards = [
  { value: 'employee', icon: '≡ƒæñ', color: 'bg-blue-500/10 border-blue-500/30' },
  { value: 'contractor_longterm', icon: '≡ƒöº', color: 'bg-amber-500/10 border-amber-500/30' },
  { value: 'contractor_shortterm', icon: 'ΓÜí', color: 'bg-orange-500/10 border-orange-500/30' },
  { value: 'member', icon: '≡ƒÅà', color: 'bg-purple-500/10 border-purple-500/30' },
  { value: 'visitor', icon: '≡ƒæï', color: 'bg-gray-500/10 border-gray-500/30' },
];
                          ...
                          <FormItem className="flex items-center justify-between space-y-0">
                            <div className="space-y-1">
                              ...
                              <Badge variant={hasLogin ? "default" : "secondary"} className="text-xs">
                                {hasLogin 
                                  ? t('userManagement.licensedUser', '≡ƒöÉ Licensed User')
                                  : t('userManagement.billableProfile', '≡ƒôï Profile Only')}
                              </Badge>
                            </div>
                            <FormControl>
                        ...
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} value={field.value || 'email'} dir={direction}>
                            ...
                            <SelectContent dir={direction} className="bg-popover">
                              <SelectItem value="email">≡ƒôº {t('invitations.viaEmail', 'Email Only')}</SelectItem>
                              <SelectItem value="whatsapp">≡ƒÆ¼ {t('invitations.viaWhatsApp', 'WhatsApp Only')}</SelectItem>
                              <SelectItem value="both">≡ƒôº≡ƒÆ¼ {t('invitations.viaBoth', 'Email & WhatsApp')}</SelectItem>
                            </SelectContent>
                          </Select>
                        </FormItem>
                      )}
                ...
                <TabsContent value="details" className="space-y-4 mt-0">
                  ...
                  {userType === 'member' && (
                    <Card>
                      <CardContent className="p-4">
                        <div className="flex items-center gap-2 mb-4">
                          <span className="text-xl">≡ƒÅà</span>
