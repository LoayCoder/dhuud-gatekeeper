...
| 22 | `hsseDashboard.trirRate` | TRIR | *Missing* | Missing Translation | **Med** | معدل تكرار الحوادث المسجلة (TRIR) | KPI Terminology. |
...
| 25 | `userManagement.resetPassword` | Reset Password | *Missing* | Missing Translation | **High** | إعادة تعيين كلمة المرور | Missing in `userManagement` scope specifically. |
